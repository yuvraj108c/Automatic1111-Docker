...
nohup jupyter-lab --allow-root --ip  0.0.0.0 --NotebookApp.token='' --notebook-dir /workspace/stable-diffusion-webui --NotebookApp.allow_origin=* --NotebookApp.allow_remote_access=1 &
